...
public class LaunchWarehouseHistoryController extends Application {
    private static final String WAREHOUSEHISTORY_FXML_PATH = "/view/WarehouseHistory.fxml";
    ...
    public LaunchWarehouseHistoryController(Stage primaryStage) {
         try {
            ...
            orderLoader.setLocation(Main.class.getResource(WAREHOUSEHISTORY_FXML_PATH));
            ...
            System.err.println("File " + WAREHOUSEHISTORY_FXML_PATH + " non trovato");
